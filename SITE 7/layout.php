...
<div class='all <?php echo $language; ?>'><div>
	...
	<div class='menu'>
		...
		<a href='./forum' class='o8' target='_blank'></a>
	</div>
	...
	<div class='conteudo'>
		...
		<div class='lateral E'>
			...
			if($dpage['olyrak'] == 1 || $dpage['bosstt'] == 1 || $dpage['csiege'] == 1 || $dpage['topcla'] == 1) {
				...
				<div class='box'>
					...
					<div class='botoes'>
						".($dpage['olyrak'] == 1 ? "<a href='./?page=oly_rank' class='b1'></a>" : "")."
						".($dpage['bosstt'] == 1 ? "<a href='./?page=boss' class='b2'></a>" : "")."
						".($dpage['csiege'] == 1 ? "<a href='./?page=siege' class='b3'></a>" : "")."
						".($dpage['topcla'] == 1 ? "<a href='./?page=topclan' class='b4'></a>" : "")."
					</div>
				</div>
				";
    ...
    for ($i = 1, $c = (!empty($asideRankCount) ? intval($asideRankCount) : 3); $i <= $c; $i++) {
        echo "<div>".$i."&ordm;&nbsp;&nbsp; Player <span>0 pvps</span></div>";
			...
			<div class='box support'>
				...
				<a href='#'><img src='imgs/ChatON.png' /></a>
			</div>
		...
		<div class='lateral D'>
			...
			<div class='box'>
				...
				<a href='./?page=donations' class='botao_donation'></a>
			</div>
