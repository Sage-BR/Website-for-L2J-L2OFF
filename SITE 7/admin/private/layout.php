...
<head>
	...
	<title>Atualstudio Web Admin 3.1</title>
	...
	<meta property="og:title" content="Atualstudio Web Admin 3.1" />
	<meta property="og:site_name" content="Atualstudio Web Admin 3.1" />
...
<body class="hold-transition skin-blue sidebar-mini<?php echo (!empty($_COOKIE['sidebarCollapse']) ? (intval($_COOKIE['sidebarCollapse']) == 1 ? ' sidebar-collapse' : '') : '') . (!empty($_COOKIE['layoutBoxed']) ? (intval($_COOKIE['layoutBoxed']) == 1 ? ' layout-boxed' : '') : ''); ?>">
	...
	<div class="wrapper">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview<?php echo ($m == 'donate/' ? ' active' : ''); ?>">
						...
						<ul class="treeview-menu">
							...
							<li><a href='?page=balance_list&module=donate'>Visualizar Saldos</a></li>
							<li><a href='?page=balance_add&module=donate'>Adicionar Saldo</a></li>
						</ul>
					</li> 

					<li class="treeview<?php echo ($m == 'shop/' ? ' active' : ''); ?>">
						<a href="#"><i class="fa fa-shopping-cart"></i> <span>Shop</span> <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li><a href='?page=cat_list&module=shop'>Visualizar Categorias</a></li>
							<li><a href='?page=cat_add&module=shop'>Criar Categoria</a></li>
							<li><a href='?page=pack_list&module=shop'>Visualizar Pacotes</a></li>
							<li><a href='?page=pack_add&module=shop'>Criar Pacote</a></li>
							<li><a href='?page=item_add&module=shop'>Adicionar Item</a></li>
						</ul>
					</li>
					...
					<li class="treeview<?php echo ($m == 'logs/' ? ' active' : ''); ?>">
						...
						<ul class="treeview-menu">
							<li><a href='?page=shop&module=logs'>Shop</a></li>
							<li><a href='?page=donate&module=logs'>Doações</a></li>
							<li><a href='?page=services&module=logs'>Serviços</a></li>
							<li><a href='?page=enchant&module=logs'>Enchant</a></li>
		...
		<footer class="main-footer">
			...
			Atualstudio Web Admin 3.1 &nbsp;&bull;&nbsp; Developed by <strong>Atualstudio.com</strong>
		</footer>
